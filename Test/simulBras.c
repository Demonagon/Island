...
//  glEnable (GL_CULL_FACE); // faces "non visibles" ignorees
    ...
    rainbow = LireImage("/filer/etudiants/g6/f12031026/Documents/Bulot/TP3/my-little-pony-friendship-is-magic-rainbow-dash-1440x1080-wallpaper.ppm") ;
    glBindTexture(GL_TEXTURE_2D,textures[2]);
	...
	Image poneys;
	glPixelStorei(GL_UNPACK_ALIGNMENT,1);
    poneys = LireImage("/filer/etudiants/g6/f12031026/Documents/Bulot/TP3/my-little-pony-friendship-is-magic-all-ponies.ppm") ;
    glBindTexture(GL_TEXTURE_2D,textures[1]);
    ...
    Image chrome;
    glPixelStorei(GL_UNPACK_ALIGNMENT,1);
    chrome = LireImage("/filer/etudiants/g6/f12031026/Documents/Bulot/TP3/TextureChrome.ppm") ;
    glBindTexture(GL_TEXTURE_2D,textures[0]);
