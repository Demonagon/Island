...
// le troisième est l'objet à son ancienne place.
// 2nd <- copie de l'objet détruit
// 1nd <- objet détruit dans lequel est copé l'objet déplacé
// 3nd <- l'adresse de l'objet déplacé avant le déplacement
typedef void (*IndexUpdater) (GameObject *, GameObject *,
							  GameObject *, MemoryIndex);
